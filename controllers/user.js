...
exports.getVerifyEmail = (req, res, next) => {
  ...
  const sendVerifyEmail = (token) => {
    ...
    const mailOptions = {
      to: req.user.email,
      from: 'user-services@nrdf.com',
      subject: 'Please verify your email address on NRDF',
      text: `Thank you for registering with NRDF.\n\n
...
exports.postReset = (req, res, next) => {
  ...
  const sendResetPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: 'user-services@nrdf.com',
      subject: 'Your NRDF password has been changed',
...
exports.postForgot = (req, res, next) => {
  ...
  const sendForgotPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: 'user-services@nrdf.com',
      subject: 'Reset your password on NRDF',
